...
runTest() {
	...
	# eye --quiet --nope ../dtou-lang-reasoning.n3 dtou-policy-vocabulary.ttl $dataPol $appPol --query $query --output $OUTPUT_TMP  # N3; newer eye reasoner argument (e.g. 10.19.6)
	eye --quiet --nope ../owl-rules.n3 ../dtou-core.ttl ../dtou-example-vocabulary.ttl ../dtou-lang-reasoning.n3 dtou-policy-vocabulary.ttl $dataPol $appPol --query $query --output $OUTPUT_TMP  # N3, with some OWL ontology
